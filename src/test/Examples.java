...
public final class Examples {
	...
	public static ILinearModel ingresoEjemplo01() {
		...
		model.getListaX().set(0, a);
		List<Double> b = new ArrayList<Double>();b.add(1.0);b.add(2.0);
		model.getListaX().set(1,b);
		List<Double> c = new ArrayList<Double>();c.add(-1.0);c.add(1.0);
		model.getListaX().set(2,c);
		List<Double> d = new ArrayList<Double>();d.add(0.0);d.add(1.0);
		model.getListaX().set(3,d);
		model.setResources(Arrays.asList(24.0,6.0,1.0,2.0));
		model.setListaDesigualdad(IntStream.range(0, model.getCountEcu())
				.mapToObj(x->"=<")
	...
	public static ILinearModel ingresoEjemplo02() {
		...
		model.getListaX().set(2,c);
		model.setResources(Arrays.asList(23.0,7.0,20.0));
		model.setListaDesigualdad(IntStream.range(0, model.getCountEcu())
				.mapToObj(x->"=<")
				.collect(Collectors.toCollection(ArrayList::new)));
	 ...
	 *&emsp;8+30+51=< 20<br>
	 *&emsp;61+48+8=<70<br>
	 *&emsp;Solution z=103.466 ; (1.119 ; 0 ; 0.217 ; 35.0649819 ; 0 ; 0) ### rewiew ###
	 * 
	 */
	public static ILinearModel ingresoEjemplo03() {
		...
		model.getListaX().set(2,c);
		model.setResources(Arrays.asList(89.0,20.0,70.0));
		model.setListaDesigualdad(IntStream.range(0, model.getCountEcu())
				.mapToObj(x->"=<")
				.collect(Collectors.toCollection(ArrayList::new)));
	...
	public static ILinearModel ingresoEjemplo04() {
		...
		model.getListaX().set(2,c);
		model.setResources(Arrays.asList(7900.0,-2100.0,-7700.0));
		model.setListaDesigualdad(IntStream.range(0, model.getCountEcu())
				.mapToObj(x->"=<")
				.collect(Collectors.toCollection(ArrayList::new)));
	...
	public static ILinearModel ingresoEjemplo05() {
		...
		model.getListaX().set(2,c);
		model.setResources(Arrays.asList(-6200.0,-2600.0,-7900.0));
		model.setListaDesigualdad(IntStream.range(0, model.getCountEcu())
				.mapToObj(x->"=<")
				.collect(Collectors.toCollection(ArrayList::new)));
	...
	public static ILinearModel ingresoEjemplo06() {
		...
		model.getListaX().set(1,b);
		model.setResources(Arrays.asList(-27000.0,12000.0));
		model.setListaDesigualdad(IntStream.range(0, model.getCountEcu())
				.mapToObj(x->"=<")
				.collect(Collectors.toCollection(ArrayList::new)));
	...
	public static ILinearModel ingresoEjemplo07() {
		...
		model.getListaX().set(2,c);
		model.setResources(Arrays.asList(8.0,12.0,4.0));
		model.setListaDesigualdad(IntStream.range(0, model.getCountEcu())
				.mapToObj(x->"=<")
				.collect(Collectors.toCollection(ArrayList::new)));
